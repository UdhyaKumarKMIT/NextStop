      ...
      <div className={`bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl shadow-2xl w-full max-w-md transform transition-all duration-700 ${
        ...
        <div className="relative p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-red-200 text-lg">Sign in to your account</p>
          </div>
          ...
          <div className="mt-8 space-y-4">
            ...
            >
              <span className={`inline-flex items-center text-red-200 hover:text-white transition-all duration-300 ${
              ...
              <div className={`h-0.5 bg-gradient-to-r from-transparent via-red-400 to-transparent transition-all duration-300 ${
        ...
        <div className="border-t border-white/10 p-4">
          <p className="text-center text-red-300/70 text-sm">
            Secure Login • Your Safety First
          </p>
        </div>
      </div>
